...
namespace ConsoleApp_MP2_L3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (choice.Key == ConsoleKey.C || choice.Key == ConsoleKey.P)
                {
                    ...
                    List<ITAsset3> sorteddt = assets.OrderBy(data => data.PurchaseDate).ToList();

                    Console.WriteLine("Office Code: ");
                    ...
                    foreach (ITAsset3 data in sorteddt)
                    {
                        ...
                        db1.ITAssets3.ToList().ForEach(assetdb => Console.WriteLine(assetdb.Id.ToString().PadRight(5) + assetdb.GetType().Name.PadRight(15) + assetdb.Office.PadRight(8) + assetdb.Brand.PadRight(15) + assetdb.Model.PadRight(15) + assetdb.PurchaseDate.ToString().PadRight(28) + $"USD{assetdb.Price}".ToString().PadRight(10)));
                        Console.WriteLine("Number of Assets: " + db1.ITAssets3.Count());
        ...
        private static void ReadFromDatabase()
        {
            ...
            Console.WriteLine("Id" + "    " + "NAME" + "    " + "Brand" + "       " + "Model" + "     " + "PurchaseDate" + "                          " + "OFFICE" + "    " +"PRICE");
